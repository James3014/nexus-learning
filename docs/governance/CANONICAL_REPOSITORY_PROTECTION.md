...
- Mechanism: GitHub Repository Ruleset (ID: `22367817`, Name: `"Canonical Main Protection v1"`)
- Enforcement: `active`
...
```bash
gh api repos/James3014/nexus-learning/rulesets/22367817
gh api repos/James3014/nexus-learning/branches/main --jq '{protected: .protected}'
```
Expected output:
```json
{
